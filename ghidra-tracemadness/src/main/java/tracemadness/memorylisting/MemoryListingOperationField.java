...
public class MemoryListingOperationField extends ClippingTextField implements SpacetimeTickField, SpacetimeOperationField, SpacetimeAddrField {
	...
	public MemoryListingOperationField(Long addr, Long index, Long tick, BigInteger val, Boolean is_write, String desc, String longdesc, int startX, int width, FontMetrics fm, FieldHighlightFactory hlFactory) {
