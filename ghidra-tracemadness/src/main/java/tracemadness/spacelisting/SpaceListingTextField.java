...
public class SpaceListingTextField extends ClippingTextField implements SpacetimeAddrField {

	private long addr;
	private boolean is_write;
	public SpaceListingTextField(long addr, boolean is_write, String desc, int startX, int width, FontMetrics fm, FieldHighlightFactory hlFactory) {
