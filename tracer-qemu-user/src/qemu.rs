...
extern "C" {
    ...
    pub fn qemu_plugin_get_registers()
        -> glib::Owned<*mut glib::GArray<qemu_plugin_reg_descriptor>>;
    ...
    pub fn qemu_plugin_tb_get_insn(_tb: *const qemu_plugin_tb, _idx: usize)
    ...
    pub fn qemu_plugin_get_hwaddr(_info: qemu_plugin_meminfo_t, _vaddr: u64)
...
pub(crate) extern "C" fn vcpu_tb_trans_wrapper<T>(
    id: qemu_plugin_id_t,
